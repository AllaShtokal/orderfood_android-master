    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnCart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(FoodDetail.this, "Добавлино в корзину", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void showRatingDialog() {
        if (!FoodDetail.this.isFinishing()) {
            new AppRatingDialog.Builder()
                    .setPositiveButtonText("Регистр")
                    .setNegativeButtonText("Отмена")
                    .setNoteDescriptions(Arrays.asList("Мне не нравится вкус.", "Не очень", "Это нормально", "Хорошо", "Это вкусно!"))
                    .setDefaultRating(1)
                    .setTitle("Пожалуйста, оцените эту еду.")
                    .setDescription("Пожалуйста, оцените звезды и рейтинг")
                    .setTitleTextColor(R.color.colorPrimary)
                    .setDescriptionTextColor(R.color.colorPrimary)
                    .setHint("Напишите ваши комментарии здесь.")
...
//                collapsingToolbarLayout.setTitle(currentFood.getName());
    ...
    public void onPositiveButtonClicked(int value, String comments) {
        ...
        //Rating А затем загрузить его в Firebase
        final Rating rating = new Rating(Common.currentUser.getPhone(),
                foodId,
                String.valueOf(value),
                comments);

        //Пользователь может оценить несколько
        ratingTbl.push()
                .setValue(rating)
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    @Override
                    public void onComplete(@NonNull Task<Void> task) {
                        Toast.makeText(FoodDetail.this, "Спасибо за оценку!", Toast.LENGTH_SHORT).show();
                    }
                });
