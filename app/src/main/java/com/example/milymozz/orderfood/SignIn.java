...
public class SignIn extends AppCompatActivity {
                            ...
                            if (dataSnapshot.child(edtPhone.getText().toString()).exists()) {
                                ...
                                if (user != null) {
                                    if (user.getPassword().equals(edtPassword.getText().toString())) {
                                        ...
                                        Toast.makeText(SignIn.this, "Другой пароль!", Toast.LENGTH_SHORT).show();
                                    }
                                }
    ...
    private void showForgotPwdDialog() {
        ...
        alertDialog.setTitle("Забыли пароль?");
        alertDialog.setMessage("Пожалуйста, введите Secure Code");
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        if (user != null) {
                            if (user.getSecureCode().equals(edtSecureCode.getText().toString()))
                                Toast.makeText(SignIn.this, "Пароль " + user.getPassword(), Toast.LENGTH_SHORT).show();
                            else
                                Toast.makeText(SignIn.this, "Secure code не верный!", Toast.LENGTH_SHORT).show();
                        }
