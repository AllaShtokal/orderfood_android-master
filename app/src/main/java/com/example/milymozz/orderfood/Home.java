...
//        startService(service);
    ...
    private void updateToken(String token) {
        ...
        Token data = new Token(token, false); // false Этот токен отправляется из клиентского приложения
...
//            showChangePasswordDialog();
    ...
    private void showHomeAddressDialog() {
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(Home.this);
        alertDialog.setTitle("Домашний адрес");
        alertDialog.setMessage("Пожалуйста, введите ваш домашний адрес");
                ...
                FirebaseDatabase.getInstance()
                        ...
                        .addOnCompleteListener(new OnCompleteListener<Void>() {
                            ...
                            public void onComplete(@NonNull Task<Void> task) {
                                Toast.makeText(Home.this, "Установите свой домашний адрес!", Toast.LENGTH_SHORT).show();
                            }
                        });
            }
        });
    ...
    private void showChangePasswordDialog() {
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(Home.this);
        alertDialog.setTitle("Сменить пароль");
        alertDialog.setMessage("Пожалуйста, введите ваш пароль");
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                if (edtPassword.getText().toString().equals(Common.currentUser.getPassword())) {
                    ...
                    if (edtNewPassword.getText().toString().equals(edtRepeatPassword.getText().toString())) {
                        ...
                        user.child(Common.currentUser.getPhone())
                                ...
                                .addOnCompleteListener(new OnCompleteListener<Void>() {
                                    ...
                                    public void onComplete(@NonNull Task<Void> task) {
                                        ...
                                        Toast.makeText(Home.this, "Пароль изменился!", Toast.LENGTH_SHORT).show();
                        ...
                        waitingDialog.dismiss();
                        Toast.makeText(Home.this, "Новый пароль не совпадает", Toast.LENGTH_SHORT).show();
                    }
    ...
    private void showUpdateNameDialog() {
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(Home.this);
        alertDialog.setTitle("Сбросить имя");
        alertDialog.setMessage("Пожалуйста, измените свое имя!");
                        ...
                        .addOnCompleteListener(new OnCompleteListener<Void>() {
                            ...
                            public void onComplete(@NonNull Task<Void> task) {
                                ...
                                if (task.isSuccessful()) {
                                    Toast.makeText(Home.this, "Имя изменено!", Toast.LENGTH_SHORT).show();
                                }
