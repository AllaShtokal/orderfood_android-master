...
public class Cart extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks,
    ...
    private void showAlertDialog() {
        ...
        alertDialog.setMessage("Пожалуйста, введите ваш адрес : ");
                            ...
                            .enqueue(new Callback<String>() {
                                ...
                                public void onResponse(Call<String> call, Response<String> response) {
                                    ...
                                    try {
                                        ...
                                        //final int numberOfItemsInResp = jsonObject.length();
...
//                comment = edtComment.getText().toString();
                ...
                if (!rdiShipToAddress.isChecked() && !rdiHomeAddress.isChecked()) {
                    ...
                    if (shippingAddress != null) {
                        ...
                        Toast.makeText(Cart.this, "Пожалуйста, введите или выберите адрес", Toast.LENGTH_SHORT).show();
                ...
                if (!rdiCod.isChecked() && !rdiPaypal.isChecked() && !rdiOrderBalance.isChecked()) {
                    ...
                    // После получения полной цены этого заказа, Balance полный
                    if (Double.parseDouble(Common.currentUser.getBalance().toString()) >= amount) {
                        ...
                        Toast.makeText(Cart.this, "Balance Не достаточно, пожалуйста, выберите другой способ оплаты", Toast.LENGTH_SHORT).show();
                    }
...
//                    Sender content = new Sender(serverToken.getToken(), notification);
    ...
    private void deleteCart(int position) {
        ...
        //after final, update new data from List<Order> to SQLite // Да, вернись в корзину.
        for (Order item : cart)
    ...
    private void displayLocation() {
        ...
        if (mLastLocation != null) {
            Log.d("LOCATION", "Мое местоположение : " + mLastLocation.getLatitude() + ", " + mLastLocation.getLongitude());


        } else {
//                Toast.makeText(this, "Couldn't get the location", Toast.LENGTH_SHORT).show();
            Log.d("LOCATION", "Location: Не могу получить(");
        ...
        if (viewHolder instanceof CartViewHolder) {
            ...
            snackbar.setAction("UNDO", new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    new Database(getBaseContext()).addToCart(deleteItem); // Список снова
                    //Update txtTotal
                    //Calculate total price
                    int total = 0;
                    List<Order> orders = new Database(getBaseContext()).getCarts(Common.currentUser.getPhone());
