            ...
            protected void onBindViewHolder(@NonNull final FoodViewHolder viewHolder, final int position, @NonNull final Food model) {
                ...
                viewHolder.quickCart.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Toast.makeText(SearchActivity.this, "Добавлено в корзину", Toast.LENGTH_SHORT).show();
                    }
                });
                ...
                viewHolder.fav_image.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (!localDB.isFavorites(adapter.getRef(position).getKey(), Common.currentUser.getPhone())) {
                            ...
                            viewHolder.fav_image.setImageResource(R.drawable.ic_favorite_black_24dp);
                            Toast.makeText(SearchActivity.this, "" + model.getName() + "Добавлено в Favorites", Toast.LENGTH_SHORT).show();
                        } else {
